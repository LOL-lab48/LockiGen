...
function checkStrength(pw) {
  ...
  switch (score) {
    case 0:
    case 1:
      return { text: 'Weak', color: 'red', width: '25%' };
    case 2:
      return { text: 'Medium', color: 'orange', width: '50%' };
    case 3:
      return { text: 'Strong', color: 'yellow', width: '75%' };
    case 4:
      return { text: 'Very Strong', color: 'limegreen', width: '100%' };
  }
}
